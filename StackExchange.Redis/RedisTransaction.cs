...
#warning askoutaris: ExecuteAsync overload added in order to be used for Transactions - possible bug from StackExchange
		...
		{
			return ExecuteAsync(message, processor!, default, server);
		}
